...
\toprule
& \multicolumn{4}{c|}{\textbf{Regression}} & \multicolumn{4}{c}{\textbf{Ranking}} \\CBF (TF-IDF) & 3.8035 & 1.9502 & 1.6100 & 0.3220 & 36.93\% & 5.58\% & 36.70\% & 56.90\% \\\bottomrule
\end{tabular}
\end{table*}
...
\begin{tabular}{lcccc|cccc}
\toprule
Funk SVD ($f$=10) & 2.7118 & 1.6467 & 1.4141 & 0.2828 & 37.72\% & 5.68\% & 37.62\% & 57.47\% \\\bottomrule
\end{tabular}
\end{table*}
...
\begin{tabular}{lcccc|cccc}
\toprule
NCF (MLP) & \textbf{2.5276} & \textbf{1.5898} & \textbf{1.3763} & \textbf{0.2753} & 35.54\% & 5.36\% & 36.69\% & \textbf{62.30\%} \\\bottomrule
\end{tabular}
\end{table*}
