...
\author{
  ...
  \texttt{\{24540034 - Lê Phạm Anh Tuấn\}@gm.uit.edu.vn}\\
  \texttt{\{24540015 - Bùi Hoàng Khánh Linh\}@gm.uit.edu.vn}\\
  \texttt{\{24540011 - Trần Thị Minh Hương\}@gm.uit.edu.vn}\\
}
...
NCF (MLP) & hidden=(16,), Adam lr=0.001, max\_iter=20, batch=512, early\_stopping \\
...
\begin{table*}[t]
\centering
\caption{Kết quả Collaborative Filtering (trả lời RQ1, RQ2)}
\label{tab:cf}
\begin{tabular}{lcccc|cccc}
\toprule
& \multicolumn{4}{c|}{\textbf{Regression}} & \multicolumn{4}{c}{\textbf{Ranking}} \\CBF (TF-IDF) & 3.8035 & 1.9502 & 1.6100 & 0.3220 & 36.93\% & 5.58\% & 36.70\% & 56.90\% \\User-CF (Cosine) & 2.6990 & 1.6429 & 1.4087 & 0.2817 & \textbf{39.50\%} & \textbf{5.99\%} & \textbf{39.92\%} & 59.92\% \\User-CF (Pearson) & 2.7588 & 1.6610 & 1.4195 & 0.2839 & 38.61\% & 5.81\% & 38.50\% & 58.63\% \\Item-CF (Cosine) & 2.6509 & 1.6282 & 1.4016 & 0.2803 & 38.51\% & 5.83\% & 38.27\% & 60.47\% \\Item-CF (Pearson) & 2.6910 & 1.6404 & 1.4088 & 0.2818 & 37.23\% & 5.61\% & 37.67\% & 59.18\% \\Funk SVD ($f$=10) & 2.7118 & 1.6467 & 1.4141 & 0.2828 & 37.72\% & 5.68\% & 37.62\% & 57.47\% \\NCF (MLP) & \textbf{2.5276} & \textbf{1.5898} & \textbf{1.3763} & \textbf{0.2753} & 35.54\% & 5.36\% & 36.69\% & \textbf{62.30\%} \\\bottomrule
\end{tabular}
\end{table*}
...
Content-Based & 3.8035 & 1.9502 & 1.6100 & 0.3220 & 36.93\% & 5.58\% & 36.70\% & 56.90\% \\User-CF (Cosine) & 2.6990 & 1.6429 & 1.4087 & 0.2817 & \textbf{39.50\%} & \textbf{5.99\%} & \textbf{39.92\%} & 59.92\% \\Item-CF (Cosine) & 2.6509 & 1.6282 & 1.4016 & 0.2803 & 38.51\% & 5.83\% & 38.27\% & 60.47\% \\Funk SVD & 2.7118 & 1.6467 & 1.4141 & 0.2828 & 37.72\% & 5.68\% & 37.62\% & 57.47\% \\\textbf{Neural CF} & \textbf{2.5276} & \textbf{1.5898} & \textbf{1.3763} & \textbf{0.2753} & 35.54\% & 5.36\% & 36.69\% & \textbf{62.30\%} \\\bottomrule
\end{tabular}
\end{table*}
